  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[var(--color-background-secondary)] via-[var(--color-surface-muted)] to-[var(--color-background-primary)] py-12 text-center text-[var(--color-text-primary)] shadow-[0_-12px_40px_rgba(0,0,0,0.35)] sm:py-14">
      ...
      <div className="relative z-10 px-2">
        ...
        <h2 className="mb-2 text-xl font-medium tracking-tight sm:text-[22px]">Not sure which service you need?</h2>
        <p className="mx-auto mb-4 max-w-md text-[13px] text-[var(--color-text-secondary)]">
          Book a free 30-minute call. We&apos;ll help you figure it out.
        </p>
        <Link
          href="/contact"
