...
export function ContactFormPanel() {
  ...
  return (
    <div className="min-w-0 rounded-[var(--border-radius-lg)] border border-[var(--color-border-tertiary)] bg-[var(--color-surface-raised)] p-4 shadow-[var(--shadow-card)]">
        <p className="mb-2 text-base font-semibold uppercase tracking-wide text-[var(--color-text-secondary)]">
        Project inquiry
      </p>
      <h2 className="mb-4 text-3xl font-medium">Send us a message</h2>
      ...
      >
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-2.5">
          <div>
            <label htmlFor={`${formId}-name`} className="mb-1 block text-base text-[var(--color-text-secondary)]">
              Your name
            </label>
            <input id={`${formId}-name`} name="name" type="text" placeholder="Jane Doe" className={inputClass} autoComplete="name" />
          </div>
          <div>
            <label htmlFor={`${formId}-email`} className="mb-1 block text-base text-[var(--color-text-secondary)]">
              Email
            </label>
            <input
              id={`${formId}-email`}
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-2.5">
          <div>
            <label htmlFor={`${formId}-company`} className="mb-1 block text-base text-[var(--color-text-secondary)]">
              Company
            </label>
            <input id={`${formId}-company`} name="company" type="text" placeholder="Acme Inc." className={inputClass} />
          </div>
          <div>
            <label htmlFor={`${formId}-website`} className="mb-1 block text-base text-[var(--color-text-secondary)]">
              Website (optional)
            </label>
        ...
        <fieldset className="min-w-0">
          <legend className="mb-1.5 text-base text-[var(--color-text-secondary)]">What do you need?</legend>
        ...
        <fieldset className="min-w-0">
          <legend className="mb-1.5 text-base text-[var(--color-text-secondary)]">Project budget</legend>
          <div className="flex flex-wrap gap-1.5 sm:gap-2">
            {BUDGETS.map((b) => (
        ...
        <fieldset className="min-w-0">
          <legend className="mb-1.5 text-base text-[var(--color-text-secondary)]">Timeline</legend>
          <div className="flex flex-wrap gap-1.5 sm:gap-2">
            {TIMELINES.map((t) => (
        ...
        <div>
          <label htmlFor={`${formId}-message`} className="mb-1 block text-base text-[var(--color-text-secondary)]">
