...
import { AiAgentHeroGraphic } from "./AiAgentHeroGraphic";

const { hero } = AI_AGENT_DEVELOPMENT_PAGE;
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[1.3fr_1fr] lg:gap-8">
            <div className="min-w-0">
              <h1 className="mb-3.5 max-w-3xl text-balance font-sans text-5xl font-bold leading-[1.05] tracking-[-0.03em] text-[var(--text)] md:text-6xl">
                AI that <span className="text-[var(--red)]">takes action</span> not just answers questions
              </h1>
              ...
              <div className="mt-6 flex flex-wrap gap-6 sm:gap-8">
                {hero.stats.map(({ value, label }) => (
                  <div key={label}>
                    <p className="font-sans text-4xl font-bold leading-none text-[var(--red)]">
                      {value}
                    </p>
            ...
            <div className="relative flex h-[200px] items-center justify-center sm:h-[280px]">
              <div
