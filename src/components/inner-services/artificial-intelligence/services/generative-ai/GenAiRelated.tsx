import { IconDatabaseSearch, IconMessages, IconRobot, type TablerIcon } from "@tabler/icons-react";
import Link from "next/link";
import { ContentContainer } from "@/components/layout/ContentContainer";
import { GENERATIVE_AI_PAGE, type GenAiRelatedIconId } from "@/data/site";

const relatedIcons: Record<GenAiRelatedIconId, TablerIcon> = {
  "database-search": IconDatabaseSearch,
  robot: IconRobot,
  messages: IconMessages,
};

const { related } = GENERATIVE_AI_PAGE;

export function GenAiRelated() {
  return (
