...
const { engagementModels } = GENERATIVE_AI_PAGE;

export function GenAiEngagement() {
  return (
        ...
        <div className="grid gap-3 md:grid-cols-3 md:items-stretch">
          {engagementModels.tiers.map((tier) => (
            ...
            >
              ...
              <p className="mb-3.5 text-base leading-tight text-[var(--text-muted)]">{tier.duration}</p>
