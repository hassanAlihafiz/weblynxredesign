import { IconPalette, IconSearch, IconTargetArrow, type TablerIcon } from "@tabler/icons-react";
import Link from "next/link";
import { ContentContainer } from "@/components/layout/ContentContainer";
import { SOCIAL_MEDIA_MARKETING_PAGE, type SmmRelatedIconId } from "@/data/site";

const relatedIcons: Record<SmmRelatedIconId, TablerIcon> = {
  "target-arrow": IconTargetArrow,
  search: IconSearch,
  palette: IconPalette,
};

const { related } = SOCIAL_MEDIA_MARKETING_PAGE;

export function SmmRelated() {
  return (
