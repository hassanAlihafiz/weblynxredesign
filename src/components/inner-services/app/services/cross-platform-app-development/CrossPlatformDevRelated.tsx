import { IconBrandAndroid, IconBrandApple, type TablerIcon } from "@tabler/icons-react";
...
} as const satisfies Record<(typeof CROSS_PLATFORM_APP_DEV_PAGE.related.items)[number]["icon"], TablerIcon>;

const { related } = CROSS_PLATFORM_APP_DEV_PAGE;
