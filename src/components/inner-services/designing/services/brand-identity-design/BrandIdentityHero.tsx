...
import { BrandIdentityHeroGraphic } from "./BrandIdentityHeroGraphic";

const { hero } = BRAND_IDENTITY_DESIGN_PAGE;
          ...
          <div className="grid items-center gap-10 lg:grid-cols-[1.3fr_1fr] lg:gap-8">
            <div className="min-w-0">
              ...
              <h1 className="mb-3.5 max-w-3xl text-balance font-sans text-5xl font-bold leading-[1.05] tracking-[-0.03em] text-[var(--text)] md:text-6xl">
                A brand that <span className="text-[var(--red)]">looks like you mean it</span>
              </h1>
