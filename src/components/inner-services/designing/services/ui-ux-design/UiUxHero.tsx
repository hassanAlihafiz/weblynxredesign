...
import { UiUxHeroGraphic } from "./UiUxHeroGraphic";

const { hero } = UI_UX_DESIGN_PAGE;
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[1.3fr_1fr] lg:gap-8">
            <div className="min-w-0">
              ...
              <h1 className="mb-3.5 max-w-3xl text-balance text-5xl font-bold leading-[1.05] tracking-[-0.03em] text-[var(--text)]">
                Interfaces users <span className="text-[var(--red)]">love</span> Outcomes you can measure
              </h1>
