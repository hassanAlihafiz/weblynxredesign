...
import { CloudSupportHeroGraphic } from "./CloudSupportHeroGraphic";

const { hero } = CLOUD_SUPPORT_AND_MAINTENANCE_PAGE;

export function CloudSupportHero() {
  return (
    <>
          ...
          <div className="grid items-center gap-8 lg:grid-cols-[1.3fr_1fr] lg:gap-8">
            <div className="min-w-0">
              ...
              <h1 className="mb-3.5 max-w-3xl text-balance text-6xl font-bold leading-tight tracking-[-0.02em] text-[var(--text)]">
                Your cloud, <span className="text-[var(--red)]">watched and cared for</span> around the
                clock.
              </h1>
              ...
              <div className="mt-6 flex flex-wrap gap-6 sm:gap-8">
                {hero.stats.map(({ value, label }) => (
                  <div key={label}>
                    <p className="font-sans text-4xl font-semibold leading-none text-[var(--red)]">
                      {value}
                    </p>
