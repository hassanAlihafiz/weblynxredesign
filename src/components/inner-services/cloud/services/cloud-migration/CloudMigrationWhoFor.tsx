...
const { whoFor } = CLOUD_MIGRATION_PAGE;

export function CloudMigrationWhoFor() {
  return (
    <section className="w-full border-t border-[var(--border)] bg-[var(--bg-elev)] py-9 sm:py-11">
      <ContentContainer>
        <h2 className="mb-5 max-w-3xl text-balance text-6xl font-bold leading-tight tracking-[-0.02em] text-[var(--text)]">
          you probabaly need <span className="text-[var(--red)]">cloud migration</span> if...
        </h2>
        ...
        <div className="mt-5 flex items-start gap-3 rounded-xl border border-[var(--red)] bg-[var(--bg-elev)] p-4">
