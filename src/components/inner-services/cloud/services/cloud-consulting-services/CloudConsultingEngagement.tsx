...
const { engagementModels } = CLOUD_CONSULTING_SERVICES_PAGE;

export function CloudConsultingEngagement() {
  return (
            ...
            <article
              ...
              className={
                tier.highlighted
                  ...
                  : "rounded-lg border border-[var(--border)] bg-[var(--bg-elev)] p-5"
              }
            >
              ...
              <p className="mb-1.5 text-sm font-semibold uppercase tracking-wide text-[var(--text-muted)]">{tier.code}</p>
