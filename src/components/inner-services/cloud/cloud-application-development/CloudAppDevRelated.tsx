import { IconBrain, IconCloudNetwork, IconCode, type TablerIcon } from "@tabler/icons-react";
import Link from "next/link";
import { ContentContainer } from "@/components/layout/ContentContainer";
import { CLOUD_APPLICATION_DEVELOPMENT_PAGE, type CloudAppRelatedIconId } from "@/data/site";

const relatedIcons: Record<CloudAppRelatedIconId, TablerIcon> = {
  "cloud-network": IconCloudNetwork,
  code: IconCode,
  brain: IconBrain,
};

const { related } = CLOUD_APPLICATION_DEVELOPMENT_PAGE;

export function CloudAppDevRelated() {
  return (
