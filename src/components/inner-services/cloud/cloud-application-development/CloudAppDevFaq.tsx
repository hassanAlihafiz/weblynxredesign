...
const { faq } = CLOUD_APPLICATION_DEVELOPMENT_PAGE;

export function CloudAppDevFaq() {
  const baseId = useId();
              ...
              <div key={q} className={isLast ? "" : "border-b border-[var(--border)]"}>
                ...
                >
                  <div className="min-h-0 overflow-hidden">
                    <p className="border-t border-[var(--border)] px-[18px] pb-4 pt-3 text-sm leading-relaxed text-[var(--text-muted)]">
                      {a}
                    </p>
                  </div>
                </div>
