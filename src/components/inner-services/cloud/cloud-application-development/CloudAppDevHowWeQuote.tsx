...
const { howWeQuote } = CLOUD_APPLICATION_DEVELOPMENT_PAGE;

export function CloudAppDevHowWeQuote() {
  return (
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1.4fr] lg:items-start">
          <div>
            <h2 className="max-w-md text-balance font-sans text-5xl font-bold leading-[1.05] tracking-[-0.03em] text-[var(--text)] md:text-6xl">
              Every cloud app is different. <span className="text-[var(--red)]">So is every quote.</span>
            </h2>
          </div>
          <div>
